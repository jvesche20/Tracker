...
if(isset($_GET['id'])){
	...
	$select_query = "SELECT id, username, password, email, sex, age, birthdate, phone_number, ip FROM account
	WHERE id = '$id'
	";
...
<p>Password:
<input type="password" name="password" size="30" value="<?php echo $row['password']; ?>" />
</p>
<p>Email:
...
<p>Birth Date:
<input type="text" name="birthdate" size="30" value="<?php echo $row['birthdate']; ?>" />
</p>
<p>IP:
<input type="text" name="ip" size="30" value="<?php echo $row['ip']; ?>" />
</p>
