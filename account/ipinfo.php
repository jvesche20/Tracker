...
if(isset($_GET['id'])){
	...
	$select_query = "SELECT id,ip, location, threat, distance FROM iplocation
	WHERE id = '$id'
	";
...
// Create a query for the database
$query = "SELECT id,ip, location, threat, distance FROM iplocation";
...
$row['distance'] . '</td><td align="left">' . 
$row['threat'] . '</td><td align="left">';
